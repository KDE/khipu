...
// : PlaneCurve(expression, variables, name, color)
// //     : m_solver(0)
// //     , m_show(true)
// //     , m_color(color)
// //     , m_name(name)
...
// // 
// //             
// //             if(!SolverFactory::self()->containsFor2D(bvars))
// //             {
...
// //             {
// //                 bool correct=true;
// //                 Analitza::ExpressionType expected=SolverFactory::self()->typeFor2D(bvars);
...
// //                 if(correct)
// //                 {
// //                     m_solver=static_cast<Solver2D*>(SolverFactory::self()->item2D(bvars, a.expression(), variables));
// // 
// // 
// //                     
// //                     
...
// // 
// //             
// //             if(!SolverFactory::self()->containsFor3D(bvars))
// //             {
// //                 m_errors << i18n("Function type not recognized");
// // 
...
// // 
// // 
// //                 Analitza::ExpressionType expected=SolverFactory::self()->typeFor3D(bvars);
// //                 Analitza::ExpressionType actual=a.type();
// // 
// //                 correct &= actual.canReduceTo(expected);
// // 
...
// //                 if(correct)
// //                 {
// //                     m_solver = static_cast<Solver3D*>(SolverFactory::self()->item3D(bvars, a.expression(), variables));
// // 
// //                     
// //                     
// // 
...
// }
// 
// // const Analitza::Expression& Function::lambda() const
// // {
// // 
// // 
