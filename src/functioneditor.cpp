...
// 
// 
// class FunctionEditorWidget : public QDockWidget, public Ui::FunctionEditorWidget
// {
// public:
...
// 
//         
//         FunctionEditorWidgetObj->setTabText(0, i18n("Funciones"));
//         FunctionEditorWidgetObj->setTabIcon(0, KIcon("format-list-unordered"));
// 
//         FunctionEditorWidgetObj->setTabText(1, i18nc("", "Crear"));
//         FunctionEditorWidgetObj->setTabIcon(1, KIcon("list-add"));
// 
//         FunctionEditorWidgetObj->setTabText(2, i18n("Area"));
//         FunctionEditorWidgetObj->setTabIcon(2,KIcon("office-chart-area"));
// 
// 
...
//     
// 
//     m_editor->FunctionEditorWidgetObj->setCurrentIndex(1);
// 
// 
// 
...
//     if (valid)
//     {
//         m_editor->FunctionEditorWidgetObj->setCurrentIndex(0);
//         resetAll();
//     }
//     else
//     {
...
//     m_editor->clickCancel->hide();
// 
//     m_editor->FunctionEditorWidgetObj->setTabText(1, i18n("&Crear"));
// 
...
//         m_editor->createParametric2DCurve->hide();
//         
//         m_editor->FunctionEditorWidgetObj->setTabEnabled(2,false);
